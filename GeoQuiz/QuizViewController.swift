...
class QuizViewController: UIViewController {
    ...
    @IBAction func flagButtonPressed(sender: UIButton) {
        ...
        if((correctButtonTag == 0 && sender == flagButton1 ) || (correctButtonTag == 1 && sender == flagButton2) || (correctButtonTag == 2 && sender == flagButton3)){
            displayAlert("Correct", messageText: "Move On !!")
        }else{
            displayAlert("Incorrect", messageText: "Hard luck, Try Again !!")
        }
